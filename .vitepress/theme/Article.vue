...
console.log('find index', posts[findCurrentIndex()])
...
<template>
  <article class="xl:divide-y xl:divide-gray-200 dark:xl:divide-slate-200/5">
    ...
    <div
      class="divide-y xl:divide-y-0 divide-gray-200 dark:divide-slate-200/5 px-10 xl:grid xl:grid-cols-4 xl:gap-x-10 pb-16 xl:pb-20"
      style="grid-template-rows: auto 1fr"
    >
      <div
        class="divide-y divide-gray-200 dark:divide-slate-200/5 xl:pb-0 xl:col-span-4 xl:row-span-2"
      >
